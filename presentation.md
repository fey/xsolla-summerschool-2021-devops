...
* Узнать полезные практики из Devops методологии
...
* Ansible ([deploy_helper](https://docs.ansible.com/ansible/latest/collections/community/general/deploy_helper_module.html#examples), [ansistrano](https://github.com/ansistrano/deploy)) - То же, что capistrano, deployer, только больше возможностей
